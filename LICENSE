Copyright 2025 HIRO Microdatacenters
...
4. Redistribution.
   ...
   (d) If the Work includes a "NOTICE" text file as part of its
       ...
       following places: within a NOTICE text file distributed as
       ...
       The contents of the NOTICE file are for informational
       purposes only and do not modify the License. You may add
       Your own attribution notices within Derivative Works
       that You distribute, alongside or as an addendum to the
...
10. Contribution Visibility.
    All contributions to the Work are publicly visible in this repository
    and will be monitored and reviewed by HIRO Microdatacenters.
    Please submit contributions via pull requests to ensure they are
